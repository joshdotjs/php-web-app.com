...
<html lang="en">
  <head>
    ...
    {{-- <script src="/web-comps/web-comp.js" type="module"></script> --}}
  ...
  <body>
    ...
    >
      ...
      <nav class="navlinks">
        <a href="/products"       class="navlink mr-6">Products</a>
        <a href="/product/1"      class="navlink mr-6">Product by ID</a>
        <a href="/create-product" class="navlink mr-6">Create Product</a>
        <a href="/update-product" class="navlink mr-6 inactive">Update Product</a>
        <a href="/update-product" class="navlink      inactive">Delete Product</a>
      </nav>
